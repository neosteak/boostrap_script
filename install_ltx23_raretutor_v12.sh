...
# A. Kijai FP8 dev model (23 GB) — full-steps path
...
# B. Kijai FP8 distilled v2 model — distilled path
dl_hf("Kijai/LTX2.3_comfy",
    "diffusion_models/ltx-2.3-22b-distilled_transformer_only_fp8_input_scaled_v2.safetensors",
    f"{C}/models/diffusion_models/LTXV2/ltx-2.3-22b-distilled_transformer_only_fp8_input_scaled_v2.safetensors")

# C. GGUF Q8_0 distilled (12 GB)
dl_hf("quantstack/LTX-2.3-GGUF",
    "LTX-2.3-distilled/LTX-2.3-distilled-Q8_0.gguf",
...
# D. Gemma 3 12B FP8 scaled (13 GB)
...
# E. Text projection (Kijai)
dl_hf("Kijai/LTX2.3_comfy",
    "text_encoders/ltx-2.3_text_projection_bf16.safetensors",
    f"{C}/models/text_encoders/ltx-2.3_text_projection_bf16.safetensors")

# F. Gemma GGUF Q4_K_M (for GGUF branch)
dl_hf("lmstudio-community/gemma-3-12b-it-GGUF",
    "gemma-3-12b-it-Q4_K_M.gguf",
    f"{C}/models/text_encoders/gemma-3-12b-it-Q4_K_M.gguf")

# G. Gemma QAT q4_0 unquantized (Lightricks mirror, sharded 5 parts ~24 GB total)
...
Diffusion Models:
  ...
  LTXV2/
    ltx-2.3-22b-distilled_transformer_only_fp8_input_scaled_v2 (12G)
    ltx-2.3-22b-distilled-Q8_0.gguf                           (12G)

Text Encoders:
    gemma_3_12B_it_fp8_scaled (+ e4m3fn symlink)              (13G)
    ltx-2.3_text_projection_bf16                               (0.1G)
    gemma-3-12b-it-Q4_K_M.gguf                                (7G)
