...
# Required by workflow (order matches Raretutor YouTube description)
install_node "ComfyUI-RT-LTX2-RareTools" "https://github.com/monnky/ComfyUI-RT-LTX2-RareTools"
...
# Source: GitMylo (as recommended by Raretutor)
dl(
    "GitMylo/LTX-2-comfy_gemma_fp8_e4m3fn",
    "gemma_3_12B_it_fp8_e4m3fn.safetensors",
    f"{C}/models/text_encoders/gemma_3_12B_it_fp8_e4m3fn.safetensors",
)
...
# GGUF: gemma-3-12b-it-Q4_K_M.gguf (GGUF path — source: unsloth as per Raretutor)
dl(
...
for f in gemma_3_12B_it_fp8_e4m3fn.safetensors ltx-2.3_text_projection_bf16.safetensors gemma-3-12b-it-Q4_K_M.gguf; do
