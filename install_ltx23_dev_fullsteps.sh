...
# ── 1. Kijai FP8 input-scaled dev model (23 GB) ──
dl_link("Kijai/LTX2.3_comfy",
   "diffusion_models/ltx-2.3-22b-dev_transformer_only_fp8_input_scaled.safetensors",
   f"{C}/models/diffusion_models/LTXVideo/v2/ltx-2.3-22b-dev_transformer_only_fp8_scaled.safetensors")

# ── 2. GGUF Q4 distilled model (6.5 GB) ──
...
dl_link("legraphista/gemma-3-12b-it-GGUF",
