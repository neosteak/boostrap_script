...
install_or_update_node "ComfyUI-PainterI2V"          "https://github.com/princepainter/ComfyUI-PainterI2V"
...
Custom nodes:
  ...
  - ComfyUI-KJNodes
  - ComfyUI_essentials
  - ComfyUI-PainterI2V (slow-motion fix, replaces WanImageToVideo)
