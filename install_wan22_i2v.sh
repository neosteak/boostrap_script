...
#
#  Pipeline: Image → Wan 2.2 14B I2V (fp8) → RIFE 2x → 4xPurePhoto upscale → 1080p 32fps
#
...
Next steps:
  1. Refresh ComfyUI in your browser
  2. Load workflow: Workflow > Browse Templates > Video > "Wan2.2 14B I2V"
     OR import your custom workflow JSON
  3. Set parameters: 28 steps, CFG 5.0, euler sampler, 896x504, 81 frames
  4. For post-processing: add RIFE VFI (2x) + 4xPurePhoto upscale + resize to 1920x1080

Pipeline: Image → Wan 2.2 14B (fp8) → RIFE 2x (32fps) → 4xPurePhoto → 1080p
