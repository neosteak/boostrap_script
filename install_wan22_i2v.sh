...
# ============================================================================
#  Wan 2.2 14B I2V — Official ComfyUI Template Setup
#
#  Downloads all models needed for the built-in Wan 2.2 I2V template.
#  Template accessed via: Workflow → Browse Templates → Video → Wan 2.2 14B I2V
#
#  Models: fp8 from Comfy-Org/Wan_2.2_ComfyUI_Repackaged
#  LoRA:   LightX2V 4-step acceleration (71s vs 513s per gen on 4090)
# ============================================================================
...
"${PYTHON_BIN}" - <<'PYEOF' || { echo "[wan22] WARNING: Model download failed — check disk space and network"; }
import os, shutil
...
# LoRA — LightX2V 4-step acceleration (71s vs 513s)
...
echo "[wan22] Step 3/3: Restarting..."
...
Usage:
  ...
  3. Select "Wan 2.2 14B I2V"
  4. Load an image, write a prompt, generate

With LoRA: ~71s per generation (vs ~513s without)
